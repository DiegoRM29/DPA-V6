...
REGLAS DE FORMATO CRÍTICAS:
- NO empieces con saludos ("Hola", "Vamos a analizar", "Claro", etc.). Ve DIRECTO al análisis.
- NO termines con frases tipo "Espero que te sirva" o "Si necesitas más...".
- Responde en español, completo (no cortes a la mitad). Máx 350 palabras.
- Usa HTML: <strong>, <em>, <ul>, <li>, <h4>.
- Estructura obligatoria:
  <h4>Veredicto</h4> Una sola frase clara: "Sí, recomendaría..." o "No, no recomendaría..." o "Con ajustes...".
  <h4>Por qué</h4> 2-3 razones cuantitativas usando los números del escenario.
  <h4>Riesgos</h4> 1-2 riesgos concretos.
  <h4>Ajustes que mejorarían el resultado</h4> 1-2 propuestas específicas.
